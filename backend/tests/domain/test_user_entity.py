...
def test_user_password_no_uppercase():
    with pytest.raises(InvalidPasswordError, match="Password must contain at least one uppercase letter"):
        User(
            username="testuser",
            email="testuser@example.com",
...
def test_user_password_no_lowercase():
    with pytest.raises(InvalidPasswordError, match="Password must contain at least one lowercase letter"):
        User(
            username="testuser",
            email="testuser@example.com",
